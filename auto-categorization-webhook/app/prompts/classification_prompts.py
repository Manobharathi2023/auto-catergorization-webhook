...
Priority Guidelines:
- Critical: Outage, data loss, security breach
- High: Core workflow broken, payment issues, login failures
...
{{
  "category": "<one of: Authentication, Billing, Technical, Network, Account>",
...
Authentication, Billing, Technical, Network, Account
